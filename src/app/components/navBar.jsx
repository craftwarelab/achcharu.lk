      ...
      <div className="flex items-center justify-between px-6 py-4">
        <Link href="/" className="flex items-center gap-2 group">
          <Image
            ...
            width={44}
            height={44}
            className="rounded-full border-2 border-orange-500 group-hover:scale-110 transition-transform"
          />
          ...
          <li className="relative group">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-full mt-2 bg-[#231313] shadow-lg rounded-md min-w-[260px] z-50 hidden group-hover:block max-h-[60vh] overflow-y-auto border border-orange-900">
              {categories.map((cat) => (
                <div
                  key={cat.id}
                  className="border-b last:border-b-0 border-[#2d1616]"
                >
                  <div className="flex items-center gap-2 px-4 py-2 font-semibold text-orange-300 bg-[#181111]">
                    <Image
                      src={cat.image}
                      alt={cat.name}
                      width={28}
                    ...
                    {cat.items &&
                      cat.items.map((item) => (
                        <Link
                          ...
                          className="block px-2 py-1 hover:bg-[#2d1616] text-orange-200 text-sm rounded focus:outline-none focus:ring-2 focus:ring-orange-400"
                        >
                          {item}
                        </Link>
                      ))}
